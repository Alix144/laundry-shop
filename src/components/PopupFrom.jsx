...
export default function PopupForm({ window, order,  number }) {
  ...
  return window === "addOrder" ? (
    ...
    <div action="" className="w-full px-14 py-10 bg-bodyBackground rounded-[10px] relative">
      <div className="mb-5">
        <h3 className="text-center text-pText text-xl">Edit Order</h3>
      </div>

      <form className="mb-10 flex flex-col">
        <input className="mb-10 px-3 py-2 rounded-[10px] border border-[#00000040] bg-[#EDEDED]" type="text" placeholder="Mobile Number" disabled value={number}/>
        <select name="" id="" className="mb-2 px-3 py-2 rounded-[10px] border border-[#00000040]" value={order.type}>
